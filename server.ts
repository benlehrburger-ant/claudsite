...
// Use process.cwd() for paths to work correctly when compiled to dist/
...
app.get("/articles/:id", async (req: Request<IdParams>, res: Response) => {
...
app.get("/api/articles/:id", (req: Request<IdParams>, res: Response) => {
...
// Edit post form
app.get("/admin/posts/:id/edit", (req: Request<IdParams>, res: Response) => {
  const post = db
...
app.post(
  "/api/posts",
  (req: Request<object, object, CreatePostPayload>, res: Response) => {
...
app.put(
  "/api/posts/:id",
  (req: Request<IdParams, object, UpdatePostPayload>, res: Response) => {
    const { title, slug, excerpt, content, category, published } = req.body;
...
// Delete post
app.delete("/api/posts/:id", (req: Request<IdParams>, res: Response) => {
  try {
