...
const articles = {
  'claude-opus-4-5': {
    ...
    subtitle: 'Intelligent, efficient, and the best model in the world for coding, agents, and computer use',
    date: 'November 24, 2025',
    category: 'Product',
    excerpt: 'Our newest model excels at coding and computer use while improving everyday tasks like research and spreadsheet work.',
    author: 'Anthropic',
    ...
    sections: [
      { type: 'paragraph', content: 'Anthropic has launched Claude Opus 4.5, described as "intelligent, efficient, and the best model in the world for coding, agents, and computer use." The model achieves state-of-the-art performance on software engineering benchmarks and demonstrates significant improvements across multiple domains.' },
      ...
      { type: 'paragraph', content: 'The model is accessible via Claude apps, API, and three major cloud platforms at $5/$25 per million tokens—making Opus-level capabilities more broadly available.' },
      { type: 'heading', heading: 'Notable Capabilities' },
      { type: 'paragraph', content: 'Customers highlighted strengths in autonomous task execution, code refactoring across multiple codebases, financial modeling, and long-context content generation. One tester noted the model "figures out the fix" when pointed at complex, multi-system bugs.' },
      { type: 'quote', content: 'Opus 4.5 figures out the fix when pointed at complex, multi-system bugs.' },
      { type: 'heading', heading: 'Safety Improvements' },
      { type: 'paragraph', content: 'Opus 4.5 demonstrates enhanced robustness against prompt injection attacks compared to competing frontier models, positioning it as more resistant to adversarial manipulation.' }
    ]
  },
  'economic-index': {
    id: 'economic-index',
    title: 'The Anthropic Economic Index',
    subtitle: 'Understanding AI\'s effects on the economy through real-world usage data',
    date: 'September 15, 2025',
    category: 'Research',
    excerpt: 'Understanding AI\'s effects on the economy by analyzing how people use Claude across US states and occupations.',
    ...
    sections: [
      { type: 'paragraph', content: 'The Anthropic Economic Index is a research initiative examining "AI\'s effects on the economy." The page features an interactive dashboard displaying Claude usage patterns across geographic regions and professional sectors.' },
      ...
      { type: 'paragraph', content: 'The index provides five analytical tabs:' },
      { type: 'list', items: [
        'US usage patterns',
      ...
      { type: 'paragraph', content: 'The dataset tracks Claude requests across multiple professional domains. For example, among countries, the United Arab Emirates shows significant activity in programming assistance tasks like debugging software code (5.15% of requests) and comprehensive financial guidance (2.66% of requests).' },
      ...
      { type: 'paragraph', content: 'The index represents Anthropic\'s effort to quantify AI adoption patterns and demonstrate how professionals utilize AI tools across diverse occupations and geographies.' }
    ]
  },
  'building-effective-agents': {
    ...
    excerpt: 'The most successful implementations use simple patterns rather than complex frameworks or specialized libraries.',
    ...
    sections: [
      { type: 'paragraph', content: 'Anthropic shares insights from working with dozens of teams building LLM agents. The key finding: "the most successful implementations weren\'t using complex frameworks or specialized libraries. Instead, they were building with simple, composable patterns."' },
      { type: 'quote', content: 'The most successful implementations weren\'t using complex frameworks or specialized libraries. Instead, they were building with simple, composable patterns.' },
      { type: 'heading', heading: 'Core Distinctions' },
      { type: 'paragraph', content: 'The article defines two types of agentic systems:' },
      { type: 'list', items: [
      ...
      { type: 'paragraph', content: 'The article highlights two domains showing strong results: customer support and software development, where agents enable verification, clear success metrics, and meaningful human oversight.' }
    ]
  }
};
...
app.post('/api/posts', (req, res) => {
  ...
  try {
    const result = db.prepare(`
      INSERT INTO posts (title, slug, excerpt, content, category, published)
      VALUES (?, ?, ?, ?, ?, ?)
    `).run(title, slug, excerpt, content, category || 'News', published ? 1 : 0);
...
app.put('/api/posts/:id', (req, res) => {
  ...
  try {
    db.prepare(`
      ...
      WHERE id = ?
    `).run(title, slug, excerpt, content, category, published ? 1 : 0, req.params.id);
