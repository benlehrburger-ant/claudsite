 ...
 * <p>Uses Java 21 sealed interfaces with pattern matching in switch expressions.
 * The compiler ensures all content types are handled exhaustively, and unnamed
 * variable patterns ({@code _}) enable concise matching.</p>
 *
